...
export async function adminUpdateOrderStatus(
  ...
  if (
    ...
    currentOrder.deliveryPaymentStatus !==
      "PAID"
  ) {
    throw new AppError(
...
export const courierTrackingSchema =
  z.object({
    courierName: z
      .string()
      .trim()
...
export async function adminUpdateCourierTracking(
  ...
  res.json({
    message:
      "Courier tracking information updated",
...
/**
 * Customer email/message sending has been removed.
 *
 * This endpoint no longer sends:
 * - sendAdminOrderMessageEmail
 * - notificationLog
 * - customer email
 */
...
export async function adminSendOrderMessage(
   ...
   *
   * If you want to keep the admin message
   * in the database, add/update adminMessage
   * here instead.
   */
  ...
  res.json({
    ...
    message:
      "Admin message saved successfully.",
...
export const deliveryPaymentSchema =
  z.object({
    required: z.boolean(),
